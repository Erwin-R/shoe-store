                    ...
                    <div className="lg:col-start-2 mt-20 xl:mt-32">
                        ...
                        <form className="space-y-6 mt-6" onSubmit={onSubmitHandler}>
                            ...
                            <div className='mb-3 row'>
                                ...
                                <div>
                                    <input type="text" className="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-green focus:outline-none focus:ring-green sm:text-sm" onChange={(e) => setPassword(e.target.value)} value={password} />
                                </div>
                            </div>
